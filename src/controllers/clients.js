...
/**
 * @desc Clients Controller Export 'getHierarchy' - Method: GET - Call model 'getClientsHierarchy'
 */
exports.getHierarchy = ('/:id', (req, res, next) =>
{
    let id = req.params.id;
    let filter = req.query || null;
    let regexID = /^\d+$/;
    ...
    if (regexID.test(id))
    {
        ...
        model.getClientsHierarchy(id, filter, function (err, ans)
        {
            if (err)
            {
                res.status(404).json({
...
/**
 * @desc Clients Controller Export 'getIDSHierarchy' - Method: GET - Call model 'getIDSClientsHierarchy'
 */
exports.getIDSHierarchy = ('/:id', (req, res, next) =>
{
    let id = req.params.id;
    let filter = req.query || null;
    let regexID = /^\d+$/;
    ...
    if (regexID.test(id))
    {
        ...
        model.getIDSClientsHierarchy(id, filter, function (err, ans)
        {
            if (err)
            {
                res.status(404).json({
